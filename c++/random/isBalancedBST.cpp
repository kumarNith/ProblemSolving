...
class BST{
  ...
  public:
	...
	bool isBalancedUtil(Node*);
};

bool isBalancedUtil(Node* right, Node* left){
	isBalancedUtil	
...
bool isBalanced(Node *node){
	...
	isBal_l = isBalanced(node->left);
	isBal_r = isBalanced(node->right);
	//isBalancedUtil(node->right, node->left);
